...
<?php }?>
<?php echo'<form class="j-backup" action="?'.$name.'bf" method="post"><input type="submit" name="type" value="备份模板" /><input type="submit" name="type" value="还原备份" /><input type="submit" name="type" value="删除备份" /><input type="submit" name="type"  value="生成地图" /></form>';?>