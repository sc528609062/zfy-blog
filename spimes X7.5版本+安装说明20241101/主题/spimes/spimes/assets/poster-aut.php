    ...
    function show_comiis_poster_ykzn(){
        if(comiis_poster_start_wlat == 0){
            ...
            var html = '<div id="comiis_poster_box" class="comiis_poster_nchxd">\n' +
                ...
                '<div class="comiis_tets"><div class="comiis_poster_time"><?php $this->author->screenName(); ?></div></div>\n' +
                
                '<div class="aut_card"><div class="comiis_poster_img"><img src="<?php $this->fields->img(); ?>" class="vm" id="comiis_poster_image"></div><div class="comiis_poster_tita"><?php $this->title(); ?></div>\n' +
                '<div class="comiis_poster_txta"><?php str_replace(array("\r\n","\n","\r"),'<br/>',$this->excerpt(65, '...'));?></div></div>\n' +
                
                '<div class="comiis_poster_x guig"></div><div class="comiis_poster_foot">\n' +
