...
<template>
    <el-form label-position="top" style="max-width:640px" @submit.prevent="save">
        ...
        <el-form-item label="个人介绍"><el-input v-model="form.bio" type="textarea" :rows="4" /></el-form-item>
        ...
        <el-button type="primary" :loading="saving" native-type="submit">保存资料</el-button>
    </el-form>
</template>
