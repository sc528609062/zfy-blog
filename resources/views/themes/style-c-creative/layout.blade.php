...
<body class="a-body c-body site-refined" data-sidebar="{{ data_get($theme, 'settings.global.sidebar_position', 'right') }}" data-back-to-top="{{ data_get($theme, 'settings.global.back_to_top', true) ? 'true' : 'false' }}">
