    ...
    private function defaultEditorToolbar(): array
    {
        return [
            ...
            ...array_map(fn (array $tool) => [...$tool, 'group' => 'shortcode'], [
                ['id' => 'zfy-alert', 'label' => '提示框', 'icon' => 'Warning', 'action' => 'blockWrap', 'prefix' => '{zfy-alert type="info" title="提示"}'."\n", 'suffix' => "\n".'{/zfy-alert}', 'placeholder' => '提示内容'],
                ['id' => 'zfy-callout', 'label' => '标注', 'icon' => 'InfoFilled', 'action' => 'blockWrap', 'prefix' => '{zfy-callout color="#f0ad4e"}'."\n", 'suffix' => "\n".'{/zfy-callout}', 'placeholder' => '标注内容'],
                ['id' => 'zfy-quote', 'label' => '彩色引用', 'icon' => 'ChatLineSquare', 'action' => 'blockWrap', 'prefix' => '{zfy-quote color="#af870d"}'."\n", 'suffix' => "\n".'{/zfy-quote}', 'placeholder' => '引用内容'],
