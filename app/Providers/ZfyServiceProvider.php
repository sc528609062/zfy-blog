...
class ZfyServiceProvider extends ServiceProvider
{
    ...
    private function defaultPages(): array
    {
        return [
            ...
            ['key' => 'link-redirects', 'label' => '跳转设置', 'description' => '管理外链跳转、nofollow 和新窗口策略', 'group' => 'links', 'kind' => 'placeholder', 'permission' => 'manage links', 'position' => 50],
            ['key' => 'link-checks', 'label' => '检测规则', 'description' => '配置链接可用性检测和排序规则', 'group' => 'links', 'kind' => 'table', 'permission' => 'manage links', 'status' => 'ready', 'position' => 60],
